    ...
    >
      <Container>
        ...
        >
          {/* Left - Info */}
          <div>
            <div className="w-12 h-12 rounded-lg bg-xifoz-dim flex items-center justify-center mb-5">
              <IconComponent size={24} className="text-xifoz-accent" />
            </div>
              ...
              <ul className="space-y-2.5">
                {service.features.map((feature) => (
                  <li key={feature} className="flex items-start gap-3">
                    <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-xifoz-text flex-shrink-0" />
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {service.idealFor.map((item) => (
                  <span
                    key={item}
                    className="px-3 py-1 bg-white border border-xifoz-border rounded-pill text-xs text-xifoz-text-secondary"
                  >
                    {item}
                  </span>
                ))}
