      ...
      <Container>
        ...
        >
          ...
          <div>
            ...
            <p className="text-base text-xifoz-dark-text-muted leading-relaxed mb-6">
              {service.description}
            </p>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-semibold uppercase tracking-[0.1em] text-xifoz-dark-text mb-4">
                What is included
              </h3>
              <ul className="space-y-2.5">
                {service.features.map((feature) => (
                  <li key={feature} className="flex items-start gap-3">
                    ...
                    <span className="text-sm text-xifoz-dark-text-muted">{feature}</span>
                  </li>
                ))}
              </ul>
            </div>
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {service.idealFor.map((item) => (
                  <span
                    key={item}
                    className="px-3 py-1 bg-xifoz-dark-surface border border-xifoz-dark-border rounded-pill text-xs text-xifoz-dark-text-muted"
                  >
                    {item}
                  </span>
                ))}
...
export default function Services() {
  useMeta({ title: 'Our Services', description: "Explore XIFOZ cybersecurity services: penetration testing, vulnerability assessment, SOC-as-a-Service, incident response, cloud security, and compliance consulting.", canonical: '/services' });
  return (
    <>
      <ServicesHero />
