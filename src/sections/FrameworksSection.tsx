    ...
    <SectionWrapper background="dim">
      <Container>
        <div className="text-center mb-12">
          ...
          <p className="text-base text-xifoz-dark-text-muted max-w-xl mx-auto">
        ...
        <div ref={ref} className="flex flex-wrap justify-center gap-3 md:gap-4">
          {frameworks.map((framework, index) => (
            <div
              key={framework}
              className="px-5 py-2.5 bg-xifoz-dark-surface border border-xifoz-dark-border rounded-pill text-sm font-medium text-xifoz-dark-text hover:border-xifoz-blue/20 hover:shadow-[0_0_15px_rgba(37,99,235,0.1)] transition-all duration-300 cursor-default"
              style={{
