...
export function ProcessStep({ number, title, description, className }: ProcessStepProps) {
  return (
    <div className={cn('relative pl-8 md:pl-12', className)}>
      ...
      <h3 className="text-lg md:text-xl font-semibold text-xifoz-dark-text mb-2">{title}</h3>
      <p className="text-sm md:text-base text-xifoz-dark-text-muted leading-relaxed">
        {description}
      </p>
    </div>
  );
